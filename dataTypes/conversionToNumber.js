 ...
 *
 * It works as expected for strings that represent actual numbers, like "14", "-72.134", or strings that represent numbers in scientific notation, like "2e3",
 * or special number values like "NaN" or "Infinity".
 *
 * However, the string can also contain numbers in hexadecimal, octal, and binary format. They must be preceded by 0x, 0o, or 0b respectively.
 ...
 * The Boolean true is converted to 1, and false to 0 – this is common for many programming languages.
