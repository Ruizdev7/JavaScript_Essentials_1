/*
 * Question 1: Write a code that will create variables and initialize them with values of
 * Boolean,
 * Number,
 * BigInt,
 * String,
 ...
 * Try to use string interpolation to display the value and type at the same time with a single console.log call, e.g. in the following form: 1000 [number].
 */
...
/**
 * Question 3: Carry out a chain of conversions: create a Boolean from a BigInt created from a Number that was created from a String.
